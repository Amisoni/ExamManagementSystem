                            ...
                            <table class="table">
                                ...
                                <tbody>
									...
									<tr>
										...
										<td><img src="<%=rs.getString(4)%>"height="50px" width="50px"></td>
										<td><%=rs.getString(5)%></td>
										<td><a href="course_update.jsp?no=<%=rs.getString(1) %>">Update</a></td>  

										<td><a href="course_delete.jsp?no=<%=rs.getString(1) %>">Delete</a></td> 
								</tr>
									<%
									} 
									%>
